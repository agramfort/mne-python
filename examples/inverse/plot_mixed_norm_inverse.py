...
alpha = 25  # regularization parameter between 0 and 100 (100 is high)
...
dipoles, residual = mixed_norm(
    ...
    tol=1e-4, active_set_size=100, debias=True, weights=None,
    weights_min=1., n_mxne_iter=n_mxne_iter, return_residual=True,
